...
`timescale 1ns/1ps
module test_direct_dma_AXILiteS_s_axi
#(parameter
    C_ADDR_WIDTH = 6,
    C_DATA_WIDTH = 32
)(
...
localparam
    ...
    ADDR_SOURCEADDRESS_DATA_0      = 6'h18,
    ADDR_SOURCEADDRESS_CTRL        = 6'h1c,
    ADDR_DESTINATIONADDRESS_DATA_0 = 6'h20,
    ADDR_DESTINATIONADDRESS_CTRL   = 6'h24,
    ADDR_LENGTH_R_DATA_0           = 6'h28,
    ADDR_LENGTH_R_CTRL             = 6'h2c;
