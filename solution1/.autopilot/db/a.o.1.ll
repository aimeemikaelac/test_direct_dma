; ModuleID = '/D/xilinx_workspace/test_direct_dma/solution1/.autopilot/db/a.g.1.bc'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%"class.std::ios_base::Init.0" = type {}
%"class.hls::stream.6" = type { %struct.ap_uint.5 }
%struct.ap_uint.5 = type { %struct.ap_int_base.3 }
%struct.ap_int_base.3 = type { %struct.ssdm_int.1 }
%struct.ssdm_int.1 = type { i72 }
%"class.hls::stream.0.10" = type { %struct.ap_uint.1.9 }
%struct.ap_uint.1.9 = type { %struct.ap_int_base.2.8 }
%struct.ap_int_base.2.8 = type { %struct.ssdm_int.3.7 }
%struct.ssdm_int.3.7 = type { i128 }
...
@.str6 = private unnamed_addr constant [15 x i8] c"read_mover.V.V\00", align 1 ; [#uses=1 type=[15 x i8]*]
@.str7 = private unnamed_addr constant [16 x i8] c"write_mover.V.V\00", align 1 ; [#uses=1 type=[16 x i8]*]
@.str8 = private unnamed_addr constant [14 x i8] c"in_stream.V.V\00", align 1 ; [#uses=1 type=[14 x i8]*]
@.str9 = private unnamed_addr constant [15 x i8] c"out_stream.V.V\00", align 1 ; [#uses=1 type=[15 x i8]*]
...
; [#uses=0]
define i32 @test_direct_dma(%"class.hls::stream.6"* %read_mover, %"class.hls::stream.6"* %write_mover, %"class.hls::stream.0.10"* %in_stream, %"class.hls::stream.0.10"* %out_stream, i32 %sourceAddress, i32 %destinationAddress, i32 %length, i1* %read_mover_halt, i1* %read_mover_halt_complete, i1* %write_mover_halt, i1* %write_mover_halt_complete) nounwind uwtable {
  call void (...)* @_ssdm_op_SpecBitsMap(i32 0) nounwind, !map !3332
  call void (...)* @_ssdm_op_SpecTopModule([16 x i8]* @str) nounwind
  %tmp = alloca %struct.ap_uint.5, align 8        ; [#uses=2 type=%struct.ap_uint.5*]
  %tmp.1 = alloca %struct.ap_uint.5, align 8      ; [#uses=2 type=%struct.ap_uint.5*]
  %tmp.4 = alloca %struct.ap_uint.1.9, align 16   ; [#uses=2 type=%struct.ap_uint.1.9*]
  %sourceAddress.assign = alloca i32, align 4     ; [#uses=5 type=i32*]
  %destinationAddress.assign = alloca i32, align 4 ; [#uses=5 type=i32*]
  %length.assign = alloca i32, align 4            ; [#uses=5 type=i32*]
  %tmp.6 = alloca %struct.ap_uint.1.9, align 16   ; [#uses=2 type=%struct.ap_uint.1.9*]
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.6"* %read_mover}, i64 0, metadata !3338), !dbg !3339 ; [debug line = 10:36] [debug variable = read_mover]
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.6"* %write_mover}, i64 0, metadata !3340), !dbg !3341 ; [debug line = 10:63] [debug variable = write_mover]
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.0.10"* %in_stream}, i64 0, metadata !3342), !dbg !3343 ; [debug line = 10:88] [debug variable = in_stream]
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.0.10"* %out_stream}, i64 0, metadata !3344), !dbg !3345 ; [debug line = 10:111] [debug variable = out_stream]
  call void @llvm.dbg.value(metadata !{i32 %sourceAddress}, i64 0, metadata !3346), !dbg !3347 ; [debug line = 11:21] [debug variable = sourceAddress]
  call void @llvm.dbg.value(metadata !{i32 %sourceAddress}, i64 0, metadata !3346), !dbg !3347 ; [debug line = 11:21] [debug variable = sourceAddress]
  call void @llvm.dbg.value(metadata !{i32 %sourceAddress}, i64 0, metadata !3346), !dbg !3347 ; [debug line = 11:21] [debug variable = sourceAddress]
  call void @llvm.dbg.value(metadata !{i32 %sourceAddress}, i64 0, metadata !3346), !dbg !3347 ; [debug line = 11:21] [debug variable = sourceAddress]
  call void @llvm.dbg.value(metadata !{i32 %sourceAddress}, i64 0, metadata !3346), !dbg !3347 ; [debug line = 11:21] [debug variable = sourceAddress]
  ...
  call void @llvm.dbg.declare(metadata !{i32* %sourceAddress.assign}, metadata !3346), !dbg !3347 ; [debug line = 11:21] [debug variable = sourceAddress]
  call void @llvm.dbg.value(metadata !{i32 %destinationAddress}, i64 0, metadata !3348), !dbg !3349 ; [debug line = 11:54] [debug variable = destinationAddress]
  call void @llvm.dbg.value(metadata !{i32 %destinationAddress}, i64 0, metadata !3348), !dbg !3349 ; [debug line = 11:54] [debug variable = destinationAddress]
  call void @llvm.dbg.value(metadata !{i32 %destinationAddress}, i64 0, metadata !3348), !dbg !3349 ; [debug line = 11:54] [debug variable = destinationAddress]
  call void @llvm.dbg.value(metadata !{i32 %destinationAddress}, i64 0, metadata !3348), !dbg !3349 ; [debug line = 11:54] [debug variable = destinationAddress]
  call void @llvm.dbg.value(metadata !{i32 %destinationAddress}, i64 0, metadata !3348), !dbg !3349 ; [debug line = 11:54] [debug variable = destinationAddress]
  ...
  call void @llvm.dbg.declare(metadata !{i32* %destinationAddress.assign}, metadata !3348), !dbg !3349 ; [debug line = 11:54] [debug variable = destinationAddress]
  call void @llvm.dbg.value(metadata !{i32 %length}, i64 0, metadata !3350), !dbg !3351 ; [debug line = 11:87] [debug variable = length]
  call void @llvm.dbg.value(metadata !{i32 %length}, i64 0, metadata !3350), !dbg !3351 ; [debug line = 11:87] [debug variable = length]
  call void @llvm.dbg.value(metadata !{i32 %length}, i64 0, metadata !3350), !dbg !3351 ; [debug line = 11:87] [debug variable = length]
  call void @llvm.dbg.value(metadata !{i32 %length}, i64 0, metadata !3350), !dbg !3351 ; [debug line = 11:87] [debug variable = length]
  call void @llvm.dbg.value(metadata !{i32 %length}, i64 0, metadata !3350), !dbg !3351 ; [debug line = 11:87] [debug variable = length]
  ...
  call void @llvm.dbg.declare(metadata !{i32* %length.assign}, metadata !3350), !dbg !3351 ; [debug line = 11:87] [debug variable = length]
  call void @llvm.dbg.value(metadata !{i1* %read_mover_halt}, i64 0, metadata !3352), !dbg !3353 ; [debug line = 12:18] [debug variable = read_mover_halt]
  call void @llvm.dbg.value(metadata !{i1* %read_mover_halt_complete}, i64 0, metadata !3354), !dbg !3355 ; [debug line = 12:50] [debug variable = read_mover_halt_complete]
  call void @llvm.dbg.value(metadata !{i1* %write_mover_halt}, i64 0, metadata !3356), !dbg !3357 ; [debug line = 12:91] [debug variable = write_mover_halt]
  call void @llvm.dbg.value(metadata !{i1* %write_mover_halt_complete}, i64 0, metadata !3358), !dbg !3359 ; [debug line = 12:124] [debug variable = write_mover_halt_complete]
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.0.10"* %out_stream}, i64 0, metadata !3360), !dbg !3361 ; [debug line = 70:115@12:151] [debug variable = out_stream]
  %out_stream.addr = getelementptr inbounds %"class.hls::stream.0.10"* %out_stream, i64 0, i32 0, i32 0, i32 0, i32 0, !dbg !3364 ; [#uses=1 type=i128*] [debug line = 82:129@76:135@70:128@12:151]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str5, i64 0, i64 0), i8* getelementptr inbounds ([15 x i8]* @.str9, i64 0, i64 0), i128* %out_stream.addr) nounwind, !dbg !3364 ; [debug line = 82:129@76:135@70:128@12:151]
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.0.10"* %in_stream}, i64 0, metadata !3370), !dbg !3371 ; [debug line = 52:114@12:0] [debug variable = in_stream]
  %in_stream.addr = getelementptr inbounds %"class.hls::stream.0.10"* %in_stream, i64 0, i32 0, i32 0, i32 0, i32 0, !dbg !3373 ; [#uses=1 type=i128*] [debug line = 64:127@58:133@52:126@12:0]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str5, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str8, i64 0, i64 0), i128* %in_stream.addr) nounwind, !dbg !3373 ; [debug line = 64:127@58:133@52:126@12:0]
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.6"* %write_mover}, i64 0, metadata !3379), !dbg !3380 ; [debug line = 34:115@12:0] [debug variable = write_mover]
  %write_mover.addr = getelementptr inbounds %"class.hls::stream.6"* %write_mover, i64 0, i32 0, i32 0, i32 0, i32 0, !dbg !3381 ; [#uses=1 type=i72*] [debug line = 46:131@40:137@34:129@12:0]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str5, i64 0, i64 0), i8* getelementptr inbounds ([16 x i8]* @.str7, i64 0, i64 0), i72* %write_mover.addr) nounwind, !dbg !3381 ; [debug line = 46:131@40:137@34:129@12:0]
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.6"* %read_mover}, i64 0, metadata !3387), !dbg !3388 ; [debug line = 16:114@12:0] [debug variable = read_mover]
  %read_mover.addr = getelementptr inbounds %"class.hls::stream.6"* %read_mover, i64 0, i32 0, i32 0, i32 0, i32 0, !dbg !3389 ; [#uses=1 type=i72*] [debug line = 28:129@22:135@16:127@12:0]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str5, i64 0, i64 0), i8* getelementptr inbounds ([15 x i8]* @.str6, i64 0, i64 0), i72* %read_mover.addr) nounwind, !dbg !3389 ; [debug line = 28:129@22:135@16:127@12:0]
  call void (...)* @_ssdm_op_SpecWire(i1* %write_mover_halt_complete, i8* getelementptr inbounds ([8 x i8]* @.str, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !3395 ; [debug line = 13:1]
  call void (...)* @_ssdm_op_SpecWire(i1* %write_mover_halt, i8* getelementptr inbounds ([8 x i8]* @.str, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !3396 ; [debug line = 15:1]
  call void (...)* @_ssdm_op_SpecWire(i1* %read_mover_halt_complete, i8* getelementptr inbounds ([8 x i8]* @.str, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !3397 ; [debug line = 17:1]
  call void (...)* @_ssdm_op_SpecWire(i1* %read_mover_halt, i8* getelementptr inbounds ([8 x i8]* @.str, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !3398 ; [debug line = 19:1]
  call void (...)* @_ssdm_op_SpecWire(%"class.hls::stream.6"* %write_mover, i8* getelementptr inbounds ([5 x i8]* @.str2, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !3399 ; [debug line = 21:1]
  call void (...)* @_ssdm_op_SpecWire(%"class.hls::stream.6"* %read_mover, i8* getelementptr inbounds ([5 x i8]* @.str2, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !3400 ; [debug line = 23:1]
  call void (...)* @_ssdm_op_SpecWire(i32 0, i8* getelementptr inbounds ([10 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !3401 ; [debug line = 25:1]
  call void (...)* @_ssdm_op_SpecWire(i32* %length.assign, i8* getelementptr inbounds ([10 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !3402 ; [debug line = 27:1]
  call void (...)* @_ssdm_op_SpecWire(i32* %length.assign, i8* getelementptr inbounds ([7 x i8]* @.str4, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !3403 ; [debug line = 29:1]
  call void (...)* @_ssdm_op_SpecWire(i32* %destinationAddress.assign, i8* getelementptr inbounds ([7 x i8]* @.str4, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !3404 ; [debug line = 31:1]
  call void (...)* @_ssdm_op_SpecWire(i32* %sourceAddress.assign, i8* getelementptr inbounds ([7 x i8]* @.str4, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !3405 ; [debug line = 33:1]
  call void (...)* @_ssdm_op_SpecWire(%"class.hls::stream.0.10"* %out_stream, i8* getelementptr inbounds ([5 x i8]* @.str2, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !3406 ; [debug line = 40:1]
  call void (...)* @_ssdm_op_SpecWire(%"class.hls::stream.0.10"* %in_stream, i8* getelementptr inbounds ([5 x i8]* @.str2, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !3407 ; [debug line = 42:1]
  call void (...)* @_ssdm_op_SpecWire(i32* %destinationAddress.assign, i8* getelementptr inbounds ([10 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !3408 ; [debug line = 44:1]
  call void (...)* @_ssdm_op_SpecWire(i32* %sourceAddress.assign, i8* getelementptr inbounds ([10 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !3409 ; [debug line = 46:1]
  call void @llvm.dbg.value(metadata !{i32* %sourceAddress.assign}, i64 0, metadata !3346), !dbg !3410 ; [debug line = 48:39] [debug variable = sourceAddress]
  call void @llvm.dbg.value(metadata !{i32* %sourceAddress.assign}, i64 0, metadata !3346), !dbg !3410 ; [debug line = 48:39] [debug variable = sourceAddress]
  call void @llvm.dbg.value(metadata !{i32* %sourceAddress.assign}, i64 0, metadata !3346), !dbg !3410 ; [debug line = 48:39] [debug variable = sourceAddress]
  call void @llvm.dbg.value(metadata !{i32* %sourceAddress.assign}, i64 0, metadata !3346), !dbg !3410 ; [debug line = 48:39] [debug variable = sourceAddress]
  call void @llvm.dbg.value(metadata !{i32* %sourceAddress.assign}, i64 0, metadata !3346), !dbg !3410 ; [debug line = 48:39] [debug variable = sourceAddress]
  ...
  call void @llvm.dbg.value(metadata !{i32* %sourceAddress.assign}, i64 0, metadata !3346), !dbg !3410 ; [debug line = 48:39] [debug variable = sourceAddress]
  call void @llvm.dbg.value(metadata !{i32* %sourceAddress.assign}, i64 0, metadata !3346), !dbg !3410 ; [debug line = 48:39] [debug variable = sourceAddress]
  %sourceOffset.0 = load volatile i32* %sourceAddress.assign, align 4, !dbg !3410 ; [#uses=0 type=i32] [debug line = 48:39]
  call void @llvm.dbg.value(metadata !{i32 %sourceOffset.0}, i64 0, metadata !3411), !dbg !3410 ; [debug line = 48:39] [debug variable = sourceOffset]
  call void @llvm.dbg.value(metadata !{i32* %destinationAddress.assign}, i64 0, metadata !3348), !dbg !3412 ; [debug line = 49:42] [debug variable = destinationAddress]
  call void @llvm.dbg.value(metadata !{i32* %destinationAddress.assign}, i64 0, metadata !3348), !dbg !3412 ; [debug line = 49:42] [debug variable = destinationAddress]
  call void @llvm.dbg.value(metadata !{i32* %destinationAddress.assign}, i64 0, metadata !3348), !dbg !3412 ; [debug line = 49:42] [debug variable = destinationAddress]
  call void @llvm.dbg.value(metadata !{i32* %destinationAddress.assign}, i64 0, metadata !3348), !dbg !3412 ; [debug line = 49:42] [debug variable = destinationAddress]
  call void @llvm.dbg.value(metadata !{i32* %destinationAddress.assign}, i64 0, metadata !3348), !dbg !3412 ; [debug line = 49:42] [debug variable = destinationAddress]
  ...
  call void @llvm.dbg.value(metadata !{i32* %destinationAddress.assign}, i64 0, metadata !3348), !dbg !3412 ; [debug line = 49:42] [debug variable = destinationAddress]
  call void @llvm.dbg.value(metadata !{i32* %destinationAddress.assign}, i64 0, metadata !3348), !dbg !3412 ; [debug line = 49:42] [debug variable = destinationAddress]
  %destOffset.0 = load volatile i32* %destinationAddress.assign, align 4, !dbg !3412 ; [#uses=0 type=i32] [debug line = 49:42]
  call void @llvm.dbg.value(metadata !{i32 %destOffset.0}, i64 0, metadata !3413), !dbg !3412 ; [debug line = 49:42] [debug variable = destOffset]
  call void @llvm.dbg.value(metadata !{i32* %length.assign}, i64 0, metadata !3350), !dbg !3414 ; [debug line = 51:29] [debug variable = length]
  call void @llvm.dbg.value(metadata !{i32* %length.assign}, i64 0, metadata !3350), !dbg !3414 ; [debug line = 51:29] [debug variable = length]
  call void @llvm.dbg.value(metadata !{i32* %length.assign}, i64 0, metadata !3350), !dbg !3414 ; [debug line = 51:29] [debug variable = length]
  call void @llvm.dbg.value(metadata !{i32* %length.assign}, i64 0, metadata !3350), !dbg !3414 ; [debug line = 51:29] [debug variable = length]
  call void @llvm.dbg.value(metadata !{i32* %length.assign}, i64 0, metadata !3350), !dbg !3414 ; [debug line = 51:29] [debug variable = length]
  ...
  call void @llvm.dbg.value(metadata !{i32* %length.assign}, i64 0, metadata !3350), !dbg !3414 ; [debug line = 51:29] [debug variable = length]
  call void @llvm.dbg.value(metadata !{i32* %length.assign}, i64 0, metadata !3350), !dbg !3414 ; [debug line = 51:29] [debug variable = length]
  %length.assign.load = load volatile i32* %length.assign, align 4, !dbg !3414 ; [#uses=1 type=i32] [debug line = 51:29]
  %read_length = shl nsw i32 %length.assign.load, 4, !dbg !3414 ; [#uses=2 type=i32] [debug line = 51:29]
  call void @llvm.dbg.value(metadata !{i32 %read_length}, i64 0, metadata !3415), !dbg !3414 ; [debug line = 51:29] [debug variable = read_length]
  store volatile i1 true, i1* %read_mover_halt, align 1, !dbg !3416 ; [debug line = 53:2]
  br label %1, !dbg !3417                         ; [debug line = 54:2]

; <label>:1                                       ; preds = %2, %0
  %read_mover_halt_complete.load = load volatile i1* %read_mover_halt_complete, align 1, !dbg !3417 ; [#uses=1 type=i1] [debug line = 54:2]
  br i1 %read_mover_halt_complete.load, label %3, label %2, !dbg !3417 ; [debug line = 54:2]

; <label>:2                                       ; preds = %1
  store volatile i1 false, i1* %read_mover_halt, align 1, !dbg !3418 ; [debug line = 55:3]
  br label %1, !dbg !3420                         ; [debug line = 56:2]

; <label>:3                                       ; preds = %1
  store volatile i1 true, i1* %write_mover_halt, align 1, !dbg !3421 ; [debug line = 58:2]
  br label %4, !dbg !3422                         ; [debug line = 59:2]

; <label>:4                                       ; preds = %5, %3
  %write_mover_halt_complete.load = load volatile i1* %write_mover_halt_complete, align 1, !dbg !3422 ; [#uses=1 type=i1] [debug line = 59:2]
  br i1 %write_mover_halt_complete.load, label %6, label %5, !dbg !3422 ; [debug line = 59:2]

; <label>:5                                       ; preds = %4
  store volatile i1 false, i1* %write_mover_halt, align 1, !dbg !3423 ; [debug line = 60:3]
  br label %4, !dbg !3425                         ; [debug line = 61:2]

; <label>:6                                       ; preds = %4
  call void @llvm.dbg.value(metadata !{i32* %sourceAddress.assign}, i64 0, metadata !3346), !dbg !3426 ; [debug line = 81:46] [debug variable = sourceAddress]
  call void @llvm.dbg.value(metadata !{i32* %sourceAddress.assign}, i64 0, metadata !3346), !dbg !3426 ; [debug line = 81:46] [debug variable = sourceAddress]
  call void @llvm.dbg.value(metadata !{i32* %sourceAddress.assign}, i64 0, metadata !3346), !dbg !3426 ; [debug line = 81:46] [debug variable = sourceAddress]
  call void @llvm.dbg.value(metadata !{i32* %sourceAddress.assign}, i64 0, metadata !3346), !dbg !3426 ; [debug line = 81:46] [debug variable = sourceAddress]
  call void @llvm.dbg.value(metadata !{i32* %sourceAddress.assign}, i64 0, metadata !3346), !dbg !3426 ; [debug line = 81:46] [debug variable = sourceAddress]
  ...
  call void @llvm.dbg.value(metadata !{i32* %sourceAddress.assign}, i64 0, metadata !3346), !dbg !3426 ; [debug line = 81:46] [debug variable = sourceAddress]
  call void @llvm.dbg.value(metadata !{i32* %sourceAddress.assign}, i64 0, metadata !3346), !dbg !3426 ; [debug line = 81:46] [debug variable = sourceAddress]
  %val.assign = load volatile i32* %sourceAddress.assign, align 4, !dbg !3426 ; [#uses=1 type=i32] [debug line = 81:46]
  call void @llvm.dbg.value(metadata !{i32 %val.assign}, i64 0, metadata !3427), !dbg !3428 ; [debug line = 205:64@81:46] [debug variable = val]
  call void @llvm.dbg.value(metadata !{i32 %val.assign}, i64 0, metadata !3429), !dbg !3430 ; [debug line = 205:64@205:86@81:46] [debug variable = val]
  call void @llvm.dbg.value(metadata !{i32 %val.assign}, i64 0, metadata !3432), !dbg !3440 ; [debug line = 205:71@205:86@81:46] [debug variable = read_mover_source.V]
  call void @llvm.dbg.value(metadata !{i32 %read_length}, i64 0, metadata !3442), !dbg !3443 ; [debug line = 204:55@82:44] [debug variable = val]
  call void @llvm.dbg.value(metadata !{i32 %read_length}, i64 0, metadata !3445), !dbg !3446 ; [debug line = 204:55@204:77@82:44] [debug variable = val]
  call void @llvm.dbg.value(metadata !{i32 %read_length}, i64 0, metadata !3448), !dbg !3450 ; [debug line = 204:62@204:77@82:44] [debug variable = read_mover_length.V]
  call void @llvm.dbg.value(metadata !{i32 %read_length}, i64 0, metadata !3452), !dbg !3455 ; [debug line = 839:185@1393:91@1395:5@839:185@2323:91@157:119@157:120@84:50] [debug variable = __Repl2__]
  %__Result__ = call i64 @llvm.part.set.i64.i32(i64 0, i32 %read_length, i32 0, i32 31) nounwind, !dbg !3467 ; [#uses=2 type=i64] [debug line = 839:187@1393:91@1395:5@839:185@2323:91@157:119@157:120@84:50]
  call void @llvm.dbg.value(metadata !{i64 %__Result__}, i64 0, metadata !3468), !dbg !3467 ; [debug line = 839:187@1393:91@1395:5@839:185@2323:91@157:119@157:120@84:50] [debug variable = __Result__]
  call void @llvm.dbg.value(metadata !{i64 %__Result__}, i64 0, metadata !3469), !dbg !3475 ; [debug line = 839:0@1393:91@1395:5@839:185@2323:91@157:119@157:120@84:50] [debug variable = tmpVal.V]
  call void @llvm.dbg.value(metadata !{i64 %__Result__}, i64 0, metadata !3476), !dbg !3478 ; [debug line = 841:92@1393:91@1395:5@839:185@2323:91@157:119@157:120@84:50] [debug variable = __Val2__]
  call void @llvm.dbg.value(metadata !{i32 %val.assign}, i64 0, metadata !3479), !dbg !3480 ; [debug line = 841:185@1393:91@1395:5@839:185@2323:91@157:119@157:120@84:50] [debug variable = __Repl2__]
  %__Result__.1 = call i64 @llvm.part.set.i64.i32(i64 %__Result__, i32 %val.assign, i32 32, i32 63) nounwind, !dbg !3481 ; [#uses=1 type=i64] [debug line = 841:187@1393:91@1395:5@839:185@2323:91@157:119@157:120@84:50]
  call void @llvm.dbg.value(metadata !{i64 %__Result__.1}, i64 0, metadata !3482), !dbg !3481 ; [debug line = 841:187@1393:91@1395:5@839:185@2323:91@157:119@157:120@84:50] [debug variable = __Result__]
  call void @llvm.dbg.value(metadata !{i64 %__Result__.1}, i64 0, metadata !3469), !dbg !3483 ; [debug line = 841:0@1393:91@1395:5@839:185@2323:91@157:119@157:120@84:50] [debug variable = tmpVal.V]
  call void @llvm.dbg.value(metadata !{i64 %__Result__.1}, i64 0, metadata !3484), !dbg !3459 ; [debug line = 839:185@2323:91@157:119@157:120@84:50] [debug variable = __Repl2__]
  %__Result__.2 = call i72 @llvm.part.set.i72.i64(i72 0, i64 %__Result__.1, i32 0, i32 63) nounwind, !dbg !3485 ; [#uses=1 type=i72] [debug line = 839:187@2323:91@157:119@157:120@84:50]
  call void @llvm.dbg.value(metadata !{i72 %__Result__.2}, i64 0, metadata !3486), !dbg !3485 ; [debug line = 839:187@2323:91@157:119@157:120@84:50] [debug variable = __Result__]
  call void @llvm.dbg.value(metadata !{i72 %__Result__.2}, i64 0, metadata !3487), !dbg !3493 ; [debug line = 839:0@2323:91@157:119@157:120@84:50] [debug variable = tmpVal.V]
  call void @llvm.dbg.value(metadata !{i72 %__Result__.2}, i64 0, metadata !3494), !dbg !3496 ; [debug line = 841:92@2323:91@157:119@157:120@84:50] [debug variable = __Val2__]
  %__Result__.3 = call i72 @llvm.part.set.i72.i8(i72 %__Result__.2, i8 0, i32 64, i32 71) nounwind, !dbg !3497 ; [#uses=1 type=i72] [debug line = 841:187@2323:91@157:119@157:120@84:50]
  call void @llvm.dbg.value(metadata !{i72 %__Result__.3}, i64 0, metadata !3498), !dbg !3497 ; [debug line = 841:187@2323:91@157:119@157:120@84:50] [debug variable = __Result__]
  call void @llvm.dbg.value(metadata !{i72 %__Result__.3}, i64 0, metadata !3487), !dbg !3499 ; [debug line = 841:0@2323:91@157:119@157:120@84:50] [debug variable = tmpVal.V]
  call void @llvm.dbg.value(metadata !{i72 %__Result__.3}, i64 0, metadata !3500), !dbg !3504 ; [debug line = 2324:9@157:119@157:120@84:50] [debug variable = read_mover_data.V]
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.6"* %read_mover}, i64 0, metadata !3505), !dbg !3507 ; [debug line = 98:48@85:2] [debug variable = this]
  call void @llvm.dbg.declare(metadata !{%struct.ap_uint.5* %tmp}, metadata !3509) nounwind, !dbg !3511 ; [debug line = 99:22@85:2] [debug variable = tmp]
  %tmp.addr = getelementptr inbounds %struct.ap_uint.5* %tmp, i64 0, i32 0, i32 0, i32 0, !dbg !3512 ; [#uses=1 type=i72*] [debug line = 99:31@85:2]
  store i72 %__Result__.3, i72* %tmp.addr, align 8, !dbg !3512 ; [debug line = 99:31@85:2]
  %read_mover.addr.1 = getelementptr inbounds %"class.hls::stream.6"* %read_mover, i64 0, i32 0, !dbg !3513 ; [#uses=1 type=%struct.ap_uint.5*] [debug line = 100:9@85:2]
  call void @"_ssdm_op_IfWrite.Stream.%struct.ap_uint.5 = type { %struct.ap_int_base.3 }P.%struct.ap_uint.5 = type { %struct.ap_int_base.3 }P"(%struct.ap_uint.5* %read_mover.addr.1, %struct.ap_uint.5* %tmp) nounwind, !dbg !3513 ; [debug line = 100:9@85:2]
  call void @llvm.dbg.value(metadata !{i32* %destinationAddress.assign}, i64 0, metadata !3348), !dbg !3514 ; [debug line = 99:52] [debug variable = destinationAddress]
  call void @llvm.dbg.value(metadata !{i32* %destinationAddress.assign}, i64 0, metadata !3348), !dbg !3514 ; [debug line = 99:52] [debug variable = destinationAddress]
  call void @llvm.dbg.value(metadata !{i32* %destinationAddress.assign}, i64 0, metadata !3348), !dbg !3514 ; [debug line = 99:52] [debug variable = destinationAddress]
  call void @llvm.dbg.value(metadata !{i32* %destinationAddress.assign}, i64 0, metadata !3348), !dbg !3514 ; [debug line = 99:52] [debug variable = destinationAddress]
  call void @llvm.dbg.value(metadata !{i32* %destinationAddress.assign}, i64 0, metadata !3348), !dbg !3514 ; [debug line = 99:52] [debug variable = destinationAddress]
  ...
  call void @llvm.dbg.value(metadata !{i32* %destinationAddress.assign}, i64 0, metadata !3348), !dbg !3514 ; [debug line = 99:52] [debug variable = destinationAddress]
  call void @llvm.dbg.value(metadata !{i32* %destinationAddress.assign}, i64 0, metadata !3348), !dbg !3514 ; [debug line = 99:52] [debug variable = destinationAddress]
  %val.assign.1 = load volatile i32* %destinationAddress.assign, align 4, !dbg !3514 ; [#uses=1 type=i32] [debug line = 99:52]
  call void @llvm.dbg.value(metadata !{i32 %val.assign.1}, i64 0, metadata !3427), !dbg !3515 ; [debug line = 205:64@99:52] [debug variable = val]
  call void @llvm.dbg.value(metadata !{i32 %val.assign.1}, i64 0, metadata !3429), !dbg !3516 ; [debug line = 205:64@205:86@99:52] [debug variable = val]
  call void @llvm.dbg.value(metadata !{i32 %val.assign.1}, i64 0, metadata !3518), !dbg !3520 ; [debug line = 205:71@205:86@99:52] [debug variable = write_mover_source.V]
  call void @llvm.dbg.value(metadata !{i32 %read_length}, i64 0, metadata !3442), !dbg !3521 ; [debug line = 204:55@100:45] [debug variable = val]
  call void @llvm.dbg.value(metadata !{i32 %read_length}, i64 0, metadata !3445), !dbg !3523 ; [debug line = 204:55@204:77@100:45] [debug variable = val]
  call void @llvm.dbg.value(metadata !{i32 %read_length}, i64 0, metadata !3525), !dbg !3527 ; [debug line = 204:62@204:77@100:45] [debug variable = write_mover_length.V]
  call void @llvm.dbg.value(metadata !{i32 %read_length}, i64 0, metadata !3452), !dbg !3528 ; [debug line = 839:185@1393:91@1395:5@839:185@2323:91@157:119@157:120@102:52] [debug variable = __Repl2__]
  call void @llvm.dbg.value(metadata !{i64 %__Result__}, i64 0, metadata !3468), !dbg !3536 ; [debug line = 839:187@1393:91@1395:5@839:185@2323:91@157:119@157:120@102:52] [debug variable = __Result__]
  call void @llvm.dbg.value(metadata !{i64 %__Result__}, i64 0, metadata !3469), !dbg !3537 ; [debug line = 839:0@1393:91@1395:5@839:185@2323:91@157:119@157:120@102:52] [debug variable = tmpVal.V]
  call void @llvm.dbg.value(metadata !{i64 %__Result__}, i64 0, metadata !3476), !dbg !3538 ; [debug line = 841:92@1393:91@1395:5@839:185@2323:91@157:119@157:120@102:52] [debug variable = __Val2__]
  call void @llvm.dbg.value(metadata !{i32 %val.assign.1}, i64 0, metadata !3479), !dbg !3539 ; [debug line = 841:185@1393:91@1395:5@839:185@2323:91@157:119@157:120@102:52] [debug variable = __Repl2__]
  %__Result__.4 = call i64 @llvm.part.set.i64.i32(i64 %__Result__, i32 %val.assign.1, i32 32, i32 63) nounwind, !dbg !3540 ; [#uses=1 type=i64] [debug line = 841:187@1393:91@1395:5@839:185@2323:91@157:119@157:120@102:52]
  call void @llvm.dbg.value(metadata !{i64 %__Result__.4}, i64 0, metadata !3482), !dbg !3540 ; [debug line = 841:187@1393:91@1395:5@839:185@2323:91@157:119@157:120@102:52] [debug variable = __Result__]
  call void @llvm.dbg.value(metadata !{i64 %__Result__.4}, i64 0, metadata !3469), !dbg !3541 ; [debug line = 841:0@1393:91@1395:5@839:185@2323:91@157:119@157:120@102:52] [debug variable = tmpVal.V]
  call void @llvm.dbg.value(metadata !{i64 %__Result__.4}, i64 0, metadata !3484), !dbg !3531 ; [debug line = 839:185@2323:91@157:119@157:120@102:52] [debug variable = __Repl2__]
  %__Result__.5 = call i72 @llvm.part.set.i72.i64(i72 0, i64 %__Result__.4, i32 0, i32 63) nounwind, !dbg !3542 ; [#uses=1 type=i72] [debug line = 839:187@2323:91@157:119@157:120@102:52]
  call void @llvm.dbg.value(metadata !{i72 %__Result__.5}, i64 0, metadata !3486), !dbg !3542 ; [debug line = 839:187@2323:91@157:119@157:120@102:52] [debug variable = __Result__]
  call void @llvm.dbg.value(metadata !{i72 %__Result__.5}, i64 0, metadata !3487), !dbg !3543 ; [debug line = 839:0@2323:91@157:119@157:120@102:52] [debug variable = tmpVal.V]
  call void @llvm.dbg.value(metadata !{i72 %__Result__.5}, i64 0, metadata !3494), !dbg !3544 ; [debug line = 841:92@2323:91@157:119@157:120@102:52] [debug variable = __Val2__]
  %__Result__.6 = call i72 @llvm.part.set.i72.i8(i72 %__Result__.5, i8 0, i32 64, i32 71) nounwind, !dbg !3545 ; [#uses=1 type=i72] [debug line = 841:187@2323:91@157:119@157:120@102:52]
  call void @llvm.dbg.value(metadata !{i72 %__Result__.6}, i64 0, metadata !3498), !dbg !3545 ; [debug line = 841:187@2323:91@157:119@157:120@102:52] [debug variable = __Result__]
  call void @llvm.dbg.value(metadata !{i72 %__Result__.6}, i64 0, metadata !3487), !dbg !3546 ; [debug line = 841:0@2323:91@157:119@157:120@102:52] [debug variable = tmpVal.V]
  call void @llvm.dbg.value(metadata !{i72 %__Result__.6}, i64 0, metadata !3547), !dbg !3549 ; [debug line = 2324:9@157:119@157:120@102:52] [debug variable = write_mover_data.V]
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.6"* %write_mover}, i64 0, metadata !3505), !dbg !3550 ; [debug line = 98:48@103:2] [debug variable = this]
  call void @llvm.dbg.declare(metadata !{%struct.ap_uint.5* %tmp.1}, metadata !3509) nounwind, !dbg !3552 ; [debug line = 99:22@103:2] [debug variable = tmp]
  %tmp.1.addr = getelementptr inbounds %struct.ap_uint.5* %tmp.1, i64 0, i32 0, i32 0, i32 0, !dbg !3553 ; [#uses=1 type=i72*] [debug line = 99:31@103:2]
  store i72 %__Result__.6, i72* %tmp.1.addr, align 8, !dbg !3553 ; [debug line = 99:31@103:2]
  %write_mover.addr.1 = getelementptr inbounds %"class.hls::stream.6"* %write_mover, i64 0, i32 0, !dbg !3554 ; [#uses=1 type=%struct.ap_uint.5*] [debug line = 100:9@103:2]
  call void @"_ssdm_op_IfWrite.Stream.%struct.ap_uint.5 = type { %struct.ap_int_base.3 }P.%struct.ap_uint.5 = type { %struct.ap_int_base.3 }P"(%struct.ap_uint.5* %write_mover.addr.1, %struct.ap_uint.5* %tmp.1) nounwind, !dbg !3554 ; [debug line = 100:9@103:2]
  %in_stream.addr.1 = getelementptr inbounds %"class.hls::stream.0.10"* %in_stream, i64 0, i32 0, !dbg !3555 ; [#uses=1 type=%struct.ap_uint.1.9*] [debug line = 85:9@121:20]
  %tmp.i.addr = getelementptr inbounds %struct.ap_uint.1.9* %tmp.4, i64 0, i32 0, i32 0, i32 0, !dbg !3560 ; [#uses=1 type=i128*] [debug line = 99:31@121:20]
  %.044.addr = getelementptr inbounds %struct.ap_uint.1.9* %tmp.6, i64 0, i32 0, i32 0, i32 0, !dbg !3560 ; [#uses=1 type=i128*] [debug line = 99:31@121:20]
  %out_stream.addr.1 = getelementptr inbounds %"class.hls::stream.0.10"* %out_stream, i64 0, i32 0, !dbg !3562 ; [#uses=1 type=%struct.ap_uint.1.9*] [debug line = 100:9@121:20]
  br label %7, !dbg !3563                         ; [debug line = 118:6]

; <label>:7                                       ; preds = %8, %6
  %i = phi i32 [ 0, %6 ], [ %i.1, %8 ]            ; [#uses=2 type=i32]
  call void @llvm.dbg.value(metadata !{i32* %length.assign}, i64 0, metadata !3350), !dbg !3563 ; [debug line = 118:6] [debug variable = length]
  call void @llvm.dbg.value(metadata !{i32* %length.assign}, i64 0, metadata !3350), !dbg !3563 ; [debug line = 118:6] [debug variable = length]
  call void @llvm.dbg.value(metadata !{i32* %length.assign}, i64 0, metadata !3350), !dbg !3563 ; [debug line = 118:6] [debug variable = length]
  call void @llvm.dbg.value(metadata !{i32* %length.assign}, i64 0, metadata !3350), !dbg !3563 ; [debug line = 118:6] [debug variable = length]
  call void @llvm.dbg.value(metadata !{i32* %length.assign}, i64 0, metadata !3350), !dbg !3563 ; [debug line = 118:6] [debug variable = length]
  ...
  call void @llvm.dbg.value(metadata !{i32* %length.assign}, i64 0, metadata !3350), !dbg !3563 ; [debug line = 118:6] [debug variable = length]
  call void @llvm.dbg.value(metadata !{i32* %length.assign}, i64 0, metadata !3350), !dbg !3563 ; [debug line = 118:6] [debug variable = length]
  %length.assign.load.1 = load volatile i32* %length.assign, align 4, !dbg !3563 ; [#uses=1 type=i32] [debug line = 118:6]
  %tmp.2 = icmp slt i32 %i, %length.assign.load.1, !dbg !3563 ; [#uses=1 type=i1] [debug line = 118:6]
  br i1 %tmp.2, label %8, label %9, !dbg !3563    ; [debug line = 118:6]

; <label>:8                                       ; preds = %7
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.0.10"* %in_stream}, i64 0, metadata !3564), !dbg !3566 ; [debug line = 83:56@121:20] [debug variable = this]
  call void @llvm.dbg.declare(metadata !{%struct.ap_uint.1.9* %tmp.6}, metadata !3567) nounwind, !dbg !3568 ; [debug line = 84:22@121:20] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{%struct.ap_uint.1.9* %tmp.6}, i64 0, metadata !3569), !dbg !3571 ; [debug line = 137:43@84:25@121:20] [debug variable = this]
  call void @llvm.dbg.value(metadata !{%struct.ap_uint.1.9* %tmp.6}, i64 0, metadata !3573), !dbg !3574 ; [debug line = 137:43@137:62@84:25@121:20] [debug variable = this]
  call void @"_ssdm_op_IfRead.Stream.%struct.ap_uint.1.9 = type { %struct.ap_int_base.2.8 }P.%struct.ap_uint.1.9 = type { %struct.ap_int_base.2.8 }P"(%struct.ap_uint.1.9* %in_stream.addr.1, %struct.ap_uint.1.9* %tmp.6) nounwind, !dbg !3555 ; [debug line = 85:9@121:20]
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.0.10"* %out_stream}, i64 0, metadata !3576), !dbg !3577 ; [debug line = 98:48@121:20] [debug variable = this]
  call void @llvm.dbg.value(metadata !{%struct.ap_uint.1.9* %tmp.6}, i64 0, metadata !3578), !dbg !3579 ; [debug line = 98:74@121:20] [debug variable = din]
  call void @llvm.dbg.declare(metadata !{%struct.ap_uint.1.9* %tmp.4}, metadata !3580) nounwind, !dbg !3581 ; [debug line = 99:22@121:20] [debug variable = tmp]
  %.044.load = load i128* %.044.addr, align 16, !dbg !3560 ; [#uses=2 type=i128] [debug line = 99:31@121:20]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i128 %.044.load) nounwind
  store i128 %.044.load, i128* %tmp.i.addr, align 16, !dbg !3560 ; [debug line = 99:31@121:20]
  call void @"_ssdm_op_IfWrite.Stream.%struct.ap_uint.1.9 = type { %struct.ap_int_base.2.8 }P.%struct.ap_uint.1.9 = type { %struct.ap_int_base.2.8 }P"(%struct.ap_uint.1.9* %out_stream.addr.1, %struct.ap_uint.1.9* %tmp.4) nounwind, !dbg !3562 ; [debug line = 100:9@121:20]
  %i.1 = add nsw i32 %i, 1, !dbg !3582            ; [#uses=1 type=i32] [debug line = 118:21]
  call void @llvm.dbg.value(metadata !{i32 %i.1}, i64 0, metadata !3583), !dbg !3582 ; [debug line = 118:21] [debug variable = i]
  br label %7, !dbg !3582                         ; [debug line = 118:21]

; <label>:9                                       ; preds = %7
  ret i32 %read_length, !dbg !3584                ; [debug line = 123:2]
}
...
; [#uses=2]
declare i72 @llvm.part.set.i72.i64(i72, i64, i32, i32) nounwind readnone
...
; [#uses=1]
declare void @"_ssdm_op_IfRead.Stream.%struct.ap_uint.1.9 = type { %struct.ap_int_base.2.8 }P.%struct.ap_uint.1.9 = type { %struct.ap_int_base.2.8 }P"(%struct.ap_uint.1.9*, %struct.ap_uint.1.9*)

; [#uses=2]
declare void @"_ssdm_op_IfWrite.Stream.%struct.ap_uint.5 = type { %struct.ap_int_base.3 }P.%struct.ap_uint.5 = type { %struct.ap_int_base.3 }P"(%struct.ap_uint.5*, %struct.ap_uint.5*)

; [#uses=1]
declare void @"_ssdm_op_IfWrite.Stream.%struct.ap_uint.1.9 = type { %struct.ap_int_base.2.8 }P.%struct.ap_uint.1.9 = type { %struct.ap_int_base.2.8 }P"(%struct.ap_uint.1.9*, %struct.ap_uint.1.9*)
...
!3333 = metadata !{i32 0, i32 31, metadata !3334}
!3334 = metadata !{metadata !3335}
!3335 = metadata !{metadata !"return", metadata !3336, metadata !"int"}
!3336 = metadata !{metadata !3337}
!3337 = metadata !{i32 0, i32 1, i32 0}
!3338 = metadata !{i32 786689, metadata !839, metadata !"read_mover", metadata !840, i32 16777226, metadata !843, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3339 = metadata !{i32 10, i32 36, metadata !839, null}
!3340 = metadata !{i32 786689, metadata !839, metadata !"write_mover", metadata !840, i32 33554442, metadata !843, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3341 = metadata !{i32 10, i32 63, metadata !839, null}
!3342 = metadata !{i32 786689, metadata !839, metadata !"in_stream", metadata !840, i32 50331658, metadata !2705, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3343 = metadata !{i32 10, i32 88, metadata !839, null}
!3344 = metadata !{i32 786689, metadata !839, metadata !"out_stream", metadata !840, i32 67108874, metadata !2705, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3345 = metadata !{i32 10, i32 111, metadata !839, null}
!3346 = metadata !{i32 786689, metadata !839, metadata !"sourceAddress", metadata !840, i32 83886091, metadata !3030, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3347 = metadata !{i32 11, i32 21, metadata !839, null}
!3348 = metadata !{i32 786689, metadata !839, metadata !"destinationAddress", metadata !840, i32 100663307, metadata !3030, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3349 = metadata !{i32 11, i32 54, metadata !839, null}
!3350 = metadata !{i32 786689, metadata !839, metadata !"length", metadata !840, i32 117440523, metadata !3031, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3351 = metadata !{i32 11, i32 87, metadata !839, null}
!3352 = metadata !{i32 786689, metadata !839, metadata !"read_mover_halt", metadata !840, i32 134217740, metadata !3032, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3353 = metadata !{i32 12, i32 18, metadata !839, null}
!3354 = metadata !{i32 786689, metadata !839, metadata !"read_mover_halt_complete", metadata !840, i32 150994956, metadata !3032, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3355 = metadata !{i32 12, i32 50, metadata !839, null}
!3356 = metadata !{i32 786689, metadata !839, metadata !"write_mover_halt", metadata !840, i32 167772172, metadata !3032, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3357 = metadata !{i32 12, i32 91, metadata !839, null}
!3358 = metadata !{i32 786689, metadata !839, metadata !"write_mover_halt_complete", metadata !840, i32 184549388, metadata !3032, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3359 = metadata !{i32 12, i32 124, metadata !839, null}
!3360 = metadata !{i32 786689, metadata !3259, metadata !"out_stream", metadata !840, i32 16777286, metadata !3004, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3361 = metadata !{i32 70, i32 115, metadata !3259, metadata !3362}
!3362 = metadata !{i32 12, i32 151, metadata !3363, null}
!3363 = metadata !{i32 786443, metadata !839, i32 12, i32 150, metadata !840, i32 0} ; [ DW_TAG_lexical_block ]
!3364 = metadata !{i32 82, i32 129, metadata !3365, metadata !3366}
!3365 = metadata !{i32 786443, metadata !3267, i32 82, i32 128, metadata !840, i32 49} ; [ DW_TAG_lexical_block ]
!3366 = metadata !{i32 76, i32 135, metadata !3367, metadata !3368}
!3367 = metadata !{i32 786443, metadata !3263, i32 76, i32 134, metadata !840, i32 48} ; [ DW_TAG_lexical_block ]
!3368 = metadata !{i32 70, i32 128, metadata !3369, metadata !3362}
!3369 = metadata !{i32 786443, metadata !3259, i32 70, i32 127, metadata !840, i32 47} ; [ DW_TAG_lexical_block ]
!3370 = metadata !{i32 786689, metadata !3239, metadata !"in_stream", metadata !840, i32 16777268, metadata !3004, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3371 = metadata !{i32 52, i32 114, metadata !3239, metadata !3372}
!3372 = metadata !{i32 12, i32 0, metadata !3363, null}
!3373 = metadata !{i32 64, i32 127, metadata !3374, metadata !3375}
!3374 = metadata !{i32 786443, metadata !3252, i32 64, i32 126, metadata !840, i32 46} ; [ DW_TAG_lexical_block ]
!3375 = metadata !{i32 58, i32 133, metadata !3376, metadata !3377}
!3376 = metadata !{i32 786443, metadata !3245, i32 58, i32 132, metadata !840, i32 45} ; [ DW_TAG_lexical_block ]
!3377 = metadata !{i32 52, i32 126, metadata !3378, metadata !3372}
!3378 = metadata !{i32 786443, metadata !3239, i32 52, i32 125, metadata !840, i32 44} ; [ DW_TAG_lexical_block ]
!3379 = metadata !{i32 786689, metadata !3227, metadata !"write_mover", metadata !840, i32 16777250, metadata !2679, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3380 = metadata !{i32 34, i32 115, metadata !3227, metadata !3372}
!3381 = metadata !{i32 46, i32 131, metadata !3382, metadata !3383}
!3382 = metadata !{i32 786443, metadata !3235, i32 46, i32 130, metadata !840, i32 43} ; [ DW_TAG_lexical_block ]
!3383 = metadata !{i32 40, i32 137, metadata !3384, metadata !3385}
!3384 = metadata !{i32 786443, metadata !3231, i32 40, i32 136, metadata !840, i32 42} ; [ DW_TAG_lexical_block ]
!3385 = metadata !{i32 34, i32 129, metadata !3386, metadata !3372}
!3386 = metadata !{i32 786443, metadata !3227, i32 34, i32 128, metadata !840, i32 41} ; [ DW_TAG_lexical_block ]
!3387 = metadata !{i32 786689, metadata !3207, metadata !"read_mover", metadata !840, i32 16777232, metadata !2679, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3388 = metadata !{i32 16, i32 114, metadata !3207, metadata !3372}
!3389 = metadata !{i32 28, i32 129, metadata !3390, metadata !3391}
!3390 = metadata !{i32 786443, metadata !3220, i32 28, i32 128, metadata !840, i32 40} ; [ DW_TAG_lexical_block ]
!3391 = metadata !{i32 22, i32 135, metadata !3392, metadata !3393}
!3392 = metadata !{i32 786443, metadata !3213, i32 22, i32 134, metadata !840, i32 39} ; [ DW_TAG_lexical_block ]
!3393 = metadata !{i32 16, i32 127, metadata !3394, metadata !3372}
!3394 = metadata !{i32 786443, metadata !3207, i32 16, i32 126, metadata !840, i32 38} ; [ DW_TAG_lexical_block ]
!3395 = metadata !{i32 13, i32 1, metadata !3363, null}
!3396 = metadata !{i32 15, i32 1, metadata !3363, null}
!3397 = metadata !{i32 17, i32 1, metadata !3363, null}
!3398 = metadata !{i32 19, i32 1, metadata !3363, null}
!3399 = metadata !{i32 21, i32 1, metadata !3363, null}
!3400 = metadata !{i32 23, i32 1, metadata !3363, null}
!3401 = metadata !{i32 25, i32 1, metadata !3363, null}
!3402 = metadata !{i32 27, i32 1, metadata !3363, null}
!3403 = metadata !{i32 29, i32 1, metadata !3363, null}
!3404 = metadata !{i32 31, i32 1, metadata !3363, null}
!3405 = metadata !{i32 33, i32 1, metadata !3363, null}
!3406 = metadata !{i32 40, i32 1, metadata !3363, null}
!3407 = metadata !{i32 42, i32 1, metadata !3363, null}
!3408 = metadata !{i32 44, i32 1, metadata !3363, null}
!3409 = metadata !{i32 46, i32 1, metadata !3363, null}
!3410 = metadata !{i32 48, i32 39, metadata !3363, null}
!3411 = metadata !{i32 786688, metadata !3363, metadata !"sourceOffset", metadata !840, i32 48, metadata !910, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3412 = metadata !{i32 49, i32 42, metadata !3363, null}
!3413 = metadata !{i32 786688, metadata !3363, metadata !"destOffset", metadata !840, i32 49, metadata !910, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3414 = metadata !{i32 51, i32 29, metadata !3363, null}
!3415 = metadata !{i32 786688, metadata !3363, metadata !"read_length", metadata !840, i32 51, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3416 = metadata !{i32 53, i32 2, metadata !3363, null}
!3417 = metadata !{i32 54, i32 2, metadata !3363, null}
!3418 = metadata !{i32 55, i32 3, metadata !3419, null}
!3419 = metadata !{i32 786443, metadata !3363, i32 54, i32 43, metadata !840, i32 1} ; [ DW_TAG_lexical_block ]
!3420 = metadata !{i32 56, i32 2, metadata !3419, null}
!3421 = metadata !{i32 58, i32 2, metadata !3363, null}
!3422 = metadata !{i32 59, i32 2, metadata !3363, null}
!3423 = metadata !{i32 60, i32 3, metadata !3424, null}
!3424 = metadata !{i32 786443, metadata !3363, i32 59, i32 44, metadata !840, i32 2} ; [ DW_TAG_lexical_block ]
!3425 = metadata !{i32 61, i32 2, metadata !3424, null}
!3426 = metadata !{i32 81, i32 46, metadata !3363, null}
!3427 = metadata !{i32 786689, metadata !3205, metadata !"val", metadata !851, i32 33554637, metadata !910, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3428 = metadata !{i32 205, i32 64, metadata !3205, metadata !3426}
!3429 = metadata !{i32 786689, metadata !3206, metadata !"val", metadata !851, i32 33554637, metadata !910, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3430 = metadata !{i32 205, i32 64, metadata !3206, metadata !3431}
!3431 = metadata !{i32 205, i32 86, metadata !3205, metadata !3426}
!3432 = metadata !{i32 790529, metadata !3433, metadata !"read_mover_source.V", null, i32 81, metadata !3434, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!3433 = metadata !{i32 786688, metadata !3363, metadata !"read_mover_source", metadata !840, i32 81, metadata !3140, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3434 = metadata !{i32 786438, null, metadata !"ap_uint<32>", metadata !851, i32 134, i64 32, i64 32, i32 0, i32 0, null, metadata !3435, i32 0, null, metadata !3201} ; [ DW_TAG_class_field_type ]
!3435 = metadata !{metadata !3436}
!3436 = metadata !{i32 786438, null, metadata !"ap_int_base<32, false, true>", metadata !829, i32 1302, i64 32, i64 32, i32 0, i32 0, null, metadata !3437, i32 0, null, metadata !2000} ; [ DW_TAG_class_field_type ]
!3437 = metadata !{metadata !3438}
!3438 = metadata !{i32 786438, null, metadata !"ssdm_int<32 + 1024 * 0, false>", metadata !858, i32 34, i64 32, i64 32, i32 0, i32 0, null, metadata !3439, i32 0, null, metadata !1551} ; [ DW_TAG_class_field_type ]
!3439 = metadata !{metadata !1545}
!3440 = metadata !{i32 205, i32 71, metadata !3441, metadata !3431}
!3441 = metadata !{i32 786443, metadata !3206, i32 205, i32 69, metadata !851, i32 37} ; [ DW_TAG_lexical_block ]
!3442 = metadata !{i32 786689, metadata !3136, metadata !"val", metadata !851, i32 33554636, metadata !56, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3443 = metadata !{i32 204, i32 55, metadata !3136, metadata !3444}
!3444 = metadata !{i32 82, i32 44, metadata !3363, null}
!3445 = metadata !{i32 786689, metadata !3202, metadata !"val", metadata !851, i32 33554636, metadata !56, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3446 = metadata !{i32 204, i32 55, metadata !3202, metadata !3447}
!3447 = metadata !{i32 204, i32 77, metadata !3136, metadata !3444}
!3448 = metadata !{i32 790529, metadata !3449, metadata !"read_mover_length.V", null, i32 82, metadata !3434, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!3449 = metadata !{i32 786688, metadata !3363, metadata !"read_mover_length", metadata !840, i32 82, metadata !3140, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3450 = metadata !{i32 204, i32 62, metadata !3451, metadata !3447}
!3451 = metadata !{i32 786443, metadata !3202, i32 204, i32 60, metadata !851, i32 34} ; [ DW_TAG_lexical_block ]
!3452 = metadata !{i32 786688, metadata !3453, metadata !"__Repl2__", metadata !829, i32 839, metadata !1546, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3453 = metadata !{i32 786443, metadata !3454, i32 839, i32 21, metadata !829, i32 18} ; [ DW_TAG_lexical_block ]
!3454 = metadata !{i32 786443, metadata !3051, i32 835, i32 78, metadata !829, i32 17} ; [ DW_TAG_lexical_block ]
!3455 = metadata !{i32 839, i32 185, metadata !3453, metadata !3456}
!3456 = metadata !{i32 1393, i32 91, metadata !3457, metadata !3458}
!3457 = metadata !{i32 786443, metadata !3050, i32 1392, i32 110, metadata !829, i32 16} ; [ DW_TAG_lexical_block ]
!3458 = metadata !{i32 1395, i32 5, metadata !3047, metadata !3459}
!3459 = metadata !{i32 839, i32 185, metadata !3460, metadata !3462}
!3460 = metadata !{i32 786443, metadata !3461, i32 839, i32 21, metadata !829, i32 14} ; [ DW_TAG_lexical_block ]
!3461 = metadata !{i32 786443, metadata !3046, i32 835, i32 78, metadata !829, i32 13} ; [ DW_TAG_lexical_block ]
!3462 = metadata !{i32 2323, i32 91, metadata !3463, metadata !3464}
!3463 = metadata !{i32 786443, metadata !3043, i32 2322, i32 110, metadata !829, i32 12} ; [ DW_TAG_lexical_block ]
!3464 = metadata !{i32 157, i32 119, metadata !3042, metadata !3465}
!3465 = metadata !{i32 157, i32 120, metadata !3041, metadata !3466}
!3466 = metadata !{i32 84, i32 50, metadata !3363, null}
!3467 = metadata !{i32 839, i32 187, metadata !3453, metadata !3456}
!3468 = metadata !{i32 786688, metadata !3453, metadata !"__Result__", metadata !829, i32 839, metadata !2069, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3469 = metadata !{i32 790529, metadata !3470, metadata !"tmpVal.V", null, i32 836, metadata !3471, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!3470 = metadata !{i32 786688, metadata !3454, metadata !"tmpVal", metadata !829, i32 836, metadata !2133, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3471 = metadata !{i32 786438, null, metadata !"ap_int_base<64, false, true>", metadata !829, i32 1302, i64 64, i64 64, i32 0, i32 0, null, metadata !3472, i32 0, null, metadata !2482} ; [ DW_TAG_class_field_type ]
!3472 = metadata !{metadata !3473}
!3473 = metadata !{i32 786438, null, metadata !"ssdm_int<64 + 1024 * 0, false>", metadata !858, i32 68, i64 64, i64 64, i32 0, i32 0, null, metadata !3474, i32 0, null, metadata !2074} ; [ DW_TAG_class_field_type ]
!3474 = metadata !{metadata !2068}
!3475 = metadata !{i32 839, i32 0, metadata !3453, metadata !3456}
!3476 = metadata !{i32 786688, metadata !3477, metadata !"__Val2__", metadata !829, i32 841, metadata !2069, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3477 = metadata !{i32 786443, metadata !3454, i32 841, i32 21, metadata !829, i32 19} ; [ DW_TAG_lexical_block ]
!3478 = metadata !{i32 841, i32 92, metadata !3477, metadata !3456}
!3479 = metadata !{i32 786688, metadata !3477, metadata !"__Repl2__", metadata !829, i32 841, metadata !1546, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3480 = metadata !{i32 841, i32 185, metadata !3477, metadata !3456}
!3481 = metadata !{i32 841, i32 187, metadata !3477, metadata !3456}
!3482 = metadata !{i32 786688, metadata !3477, metadata !"__Result__", metadata !829, i32 841, metadata !2069, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3483 = metadata !{i32 841, i32 0, metadata !3477, metadata !3456}
!3484 = metadata !{i32 786688, metadata !3460, metadata !"__Repl2__", metadata !829, i32 839, metadata !2069, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3485 = metadata !{i32 839, i32 187, metadata !3460, metadata !3462}
!3486 = metadata !{i32 786688, metadata !3460, metadata !"__Result__", metadata !829, i32 839, metadata !861, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3487 = metadata !{i32 790529, metadata !3488, metadata !"tmpVal.V", null, i32 836, metadata !3489, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!3488 = metadata !{i32 786688, metadata !3461, metadata !"tmpVal", metadata !829, i32 836, metadata !881, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3489 = metadata !{i32 786438, null, metadata !"ap_int_base<72, false, false>", metadata !829, i32 2234, i64 72, i64 64, i32 0, i32 0, null, metadata !3490, i32 0, null, metadata !1086} ; [ DW_TAG_class_field_type ]
!3490 = metadata !{metadata !3491}
!3491 = metadata !{i32 786438, null, metadata !"ssdm_int<72 + 1024 * 0, false>", metadata !858, i32 80, i64 72, i64 64, i32 0, i32 0, null, metadata !3492, i32 0, null, metadata !871} ; [ DW_TAG_class_field_type ]
!3492 = metadata !{metadata !860}
!3493 = metadata !{i32 839, i32 0, metadata !3460, metadata !3462}
!3494 = metadata !{i32 786688, metadata !3495, metadata !"__Val2__", metadata !829, i32 841, metadata !861, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3495 = metadata !{i32 786443, metadata !3461, i32 841, i32 21, metadata !829, i32 15} ; [ DW_TAG_lexical_block ]
!3496 = metadata !{i32 841, i32 92, metadata !3495, metadata !3462}
!3497 = metadata !{i32 841, i32 187, metadata !3495, metadata !3462}
!3498 = metadata !{i32 786688, metadata !3495, metadata !"__Result__", metadata !829, i32 841, metadata !861, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3499 = metadata !{i32 841, i32 0, metadata !3495, metadata !3462}
!3500 = metadata !{i32 790529, metadata !3501, metadata !"read_mover_data.V", null, i32 84, metadata !3502, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!3501 = metadata !{i32 786688, metadata !3363, metadata !"read_mover_data", metadata !840, i32 84, metadata !850, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3502 = metadata !{i32 786438, null, metadata !"ap_uint<72>", metadata !851, i32 134, i64 72, i64 64, i32 0, i32 0, null, metadata !3503, i32 0, null, metadata !2668} ; [ DW_TAG_class_field_type ]
!3503 = metadata !{metadata !3489}
!3504 = metadata !{i32 2324, i32 9, metadata !3463, metadata !3464}
!3505 = metadata !{i32 786689, metadata !3040, metadata !"this", metadata !847, i32 16777314, metadata !3506, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!3506 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !845} ; [ DW_TAG_pointer_type ]
!3507 = metadata !{i32 98, i32 48, metadata !3040, metadata !3508}
!3508 = metadata !{i32 85, i32 2, metadata !3363, null}
!3509 = metadata !{i32 786688, metadata !3510, metadata !"tmp", metadata !847, i32 99, metadata !850, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3510 = metadata !{i32 786443, metadata !3040, i32 98, i32 79, metadata !847, i32 10} ; [ DW_TAG_lexical_block ]
!3511 = metadata !{i32 99, i32 22, metadata !3510, metadata !3508}
!3512 = metadata !{i32 99, i32 31, metadata !3510, metadata !3508}
!3513 = metadata !{i32 100, i32 9, metadata !3510, metadata !3508}
!3514 = metadata !{i32 99, i32 52, metadata !3363, null}
!3515 = metadata !{i32 205, i32 64, metadata !3205, metadata !3514}
!3516 = metadata !{i32 205, i32 64, metadata !3206, metadata !3517}
!3517 = metadata !{i32 205, i32 86, metadata !3205, metadata !3514}
!3518 = metadata !{i32 790529, metadata !3519, metadata !"write_mover_source.V", null, i32 99, metadata !3434, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!3519 = metadata !{i32 786688, metadata !3363, metadata !"write_mover_source", metadata !840, i32 99, metadata !3140, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3520 = metadata !{i32 205, i32 71, metadata !3441, metadata !3517}
!3521 = metadata !{i32 204, i32 55, metadata !3136, metadata !3522}
!3522 = metadata !{i32 100, i32 45, metadata !3363, null}
!3523 = metadata !{i32 204, i32 55, metadata !3202, metadata !3524}
!3524 = metadata !{i32 204, i32 77, metadata !3136, metadata !3522}
!3525 = metadata !{i32 790529, metadata !3526, metadata !"write_mover_length.V", null, i32 100, metadata !3434, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!3526 = metadata !{i32 786688, metadata !3363, metadata !"write_mover_length", metadata !840, i32 100, metadata !3140, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3527 = metadata !{i32 204, i32 62, metadata !3451, metadata !3524}
!3528 = metadata !{i32 839, i32 185, metadata !3453, metadata !3529}
!3529 = metadata !{i32 1393, i32 91, metadata !3457, metadata !3530}
!3530 = metadata !{i32 1395, i32 5, metadata !3047, metadata !3531}
!3531 = metadata !{i32 839, i32 185, metadata !3460, metadata !3532}
!3532 = metadata !{i32 2323, i32 91, metadata !3463, metadata !3533}
!3533 = metadata !{i32 157, i32 119, metadata !3042, metadata !3534}
!3534 = metadata !{i32 157, i32 120, metadata !3041, metadata !3535}
!3535 = metadata !{i32 102, i32 52, metadata !3363, null}
!3536 = metadata !{i32 839, i32 187, metadata !3453, metadata !3529}
!3537 = metadata !{i32 839, i32 0, metadata !3453, metadata !3529}
!3538 = metadata !{i32 841, i32 92, metadata !3477, metadata !3529}
!3539 = metadata !{i32 841, i32 185, metadata !3477, metadata !3529}
!3540 = metadata !{i32 841, i32 187, metadata !3477, metadata !3529}
!3541 = metadata !{i32 841, i32 0, metadata !3477, metadata !3529}
!3542 = metadata !{i32 839, i32 187, metadata !3460, metadata !3532}
!3543 = metadata !{i32 839, i32 0, metadata !3460, metadata !3532}
!3544 = metadata !{i32 841, i32 92, metadata !3495, metadata !3532}
!3545 = metadata !{i32 841, i32 187, metadata !3495, metadata !3532}
!3546 = metadata !{i32 841, i32 0, metadata !3495, metadata !3532}
!3547 = metadata !{i32 790529, metadata !3548, metadata !"write_mover_data.V", null, i32 102, metadata !3502, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!3548 = metadata !{i32 786688, metadata !3363, metadata !"write_mover_data", metadata !840, i32 102, metadata !850, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3549 = metadata !{i32 2324, i32 9, metadata !3463, metadata !3533}
!3550 = metadata !{i32 98, i32 48, metadata !3040, metadata !3551}
!3551 = metadata !{i32 103, i32 2, metadata !3363, null}
!3552 = metadata !{i32 99, i32 22, metadata !3510, metadata !3551}
!3553 = metadata !{i32 99, i32 31, metadata !3510, metadata !3551}
!3554 = metadata !{i32 100, i32 9, metadata !3510, metadata !3551}
!3555 = metadata !{i32 85, i32 9, metadata !3556, metadata !3557}
!3556 = metadata !{i32 786443, metadata !3034, i32 83, i32 63, metadata !847, i32 5} ; [ DW_TAG_lexical_block ]
!3557 = metadata !{i32 121, i32 20, metadata !3558, null}
!3558 = metadata !{i32 786443, metadata !3559, i32 118, i32 25, metadata !840, i32 4} ; [ DW_TAG_lexical_block ]
!3559 = metadata !{i32 786443, metadata !3363, i32 118, i32 2, metadata !840, i32 3} ; [ DW_TAG_lexical_block ]
!3560 = metadata !{i32 99, i32 31, metadata !3561, metadata !3557}
!3561 = metadata !{i32 786443, metadata !3039, i32 98, i32 79, metadata !847, i32 9} ; [ DW_TAG_lexical_block ]
!3562 = metadata !{i32 100, i32 9, metadata !3561, metadata !3557}
!3563 = metadata !{i32 118, i32 6, metadata !3559, null}
!3564 = metadata !{i32 786689, metadata !3034, metadata !"this", metadata !847, i32 16777299, metadata !3565, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!3565 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !2707} ; [ DW_TAG_pointer_type ]
!3566 = metadata !{i32 83, i32 56, metadata !3034, metadata !3557}
!3567 = metadata !{i32 786688, metadata !3556, metadata !"tmp", metadata !847, i32 84, metadata !2930, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3568 = metadata !{i32 84, i32 22, metadata !3556, metadata !3557}
!3569 = metadata !{i32 786689, metadata !3035, metadata !"this", metadata !851, i32 16777353, metadata !3570, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!3570 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !2710} ; [ DW_TAG_pointer_type ]
!3571 = metadata !{i32 137, i32 43, metadata !3035, metadata !3572}
!3572 = metadata !{i32 84, i32 25, metadata !3556, metadata !3557}
!3573 = metadata !{i32 786689, metadata !3036, metadata !"this", metadata !851, i32 16777353, metadata !3570, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!3574 = metadata !{i32 137, i32 43, metadata !3036, metadata !3575}
!3575 = metadata !{i32 137, i32 62, metadata !3035, metadata !3572}
!3576 = metadata !{i32 786689, metadata !3039, metadata !"this", metadata !847, i32 16777314, metadata !3565, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!3577 = metadata !{i32 98, i32 48, metadata !3039, metadata !3557}
!3578 = metadata !{i32 786689, metadata !3039, metadata !"din", metadata !847, i32 33554530, metadata !2930, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3579 = metadata !{i32 98, i32 74, metadata !3039, metadata !3557}
!3580 = metadata !{i32 786688, metadata !3561, metadata !"tmp", metadata !847, i32 99, metadata !2710, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3581 = metadata !{i32 99, i32 22, metadata !3561, metadata !3557}
!3582 = metadata !{i32 118, i32 21, metadata !3559, null}
!3583 = metadata !{i32 786688, metadata !3363, metadata !"i", metadata !840, i32 117, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3584 = metadata !{i32 123, i32 2, metadata !3363, null}
